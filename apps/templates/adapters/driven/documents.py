"""
MongoEngine Documents para el bounded context Templates.

Estos son los modelos de persistencia — no son entidades de dominio.
"""
...
class ChecklistTemplate(Document):
    ...
    supported_vehicle_types = ListField(
        StringField(choices=VehicleType.ALL), required=True
    )
