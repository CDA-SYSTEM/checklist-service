...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "apps.common.presentation.authentication.StaticAPIKeyAuthentication",
    ],
...
RABBITMQ_TRACKER_EXCHANGE = env("RABBITMQ_TRACKER_EXCHANGE")
RABBITMQ_TRACKER_QUEUE = env("RABBITMQ_TRACKER_QUEUE")
